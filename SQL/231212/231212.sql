...
INSERT INTO 월별매출 VALUES ('P002','2019.11','삼성',25000);
INSERT INTO 월별매출 VALUES ('P003','2019.10','LG',10000);
INSERT INTO 월별매출 VALUES ('P004','2019.11','LG',20000);
INSERT INTO 월별매출 VALUES ('P005','2019.10','애플',15000);
INSERT INTO 월별매출 VALUES ('P006','2019.11','애플',10000);
...
FROM CUSTOMERS cus, COUNTRIES con
WHERE cus.COUNTRY_ID = con.COUNTRY_ID
GROUP BY (con.COUNTRY_SUBREGION, cus.CUST_GENDER IN (SELECT count(cus.CUST_ID)
FROM CUSTOMERS cus
...
SELECT 
	CASE GROUPING(con.COUNTRY_REGION) WHEN 1 THEN '총 합' ELSE con.COUNTRY_REGION END AS con.COUNTRY_REGION, 
	CASE GROUPING(cus.CUST_GENDER) WHEN 1 THEN '총 합' ELSE cus.CUST_GENDER END AS cus.CUST_GENDER,
	count(cus.CUST_GENDER) AS 성별 
FROM CUSTOMERS cus, COUNTRIES con
WHERE cus.COUNTRY_ID = con.COUNTRY_ID
GROUP BY ROLLUP (con.COUNTRY_SUBREGION, cus.CUST_GENDER);
...
SELECT d.DEPARTMENT_NAME, e.EMP_NAME, j.JOB_TITLE, jh.START_DATE 
